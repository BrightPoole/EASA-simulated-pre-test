  ...
  try {
    ...
    rootElement.innerHTML = `
      <div style="padding: 40px; color: #ef4444; font-family: system-ui, sans-serif; text-align: center; max-width: 500px; margin: 100px auto; border: 1px solid #fee2e2; border-radius: 12px; background: #fef2f2;">
        ...
        <p style="margin-bottom: 24px; color: #7f1d1d; line-height: 1.5;">The aviation simulator encountered a fatal error during startup. Please ensure your browser is up to date.</p>
        <button onclick="window.location.reload()" style="padding: 12px 24px; background: #b91c1c; color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: 600; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.1);">
...
// Global handlers to capture early-stage failures
